...
def find_overlap(img1, img2):
    ...
    gray2 = cv2.cvtColor(img2, cv2.COLOR_BGR2GRAY)
      ...
      # Convet both images to grayscale as SIFT works better with images in this format.
...
# Streamlit UI Title
st.title("Image Overlap Estimation with SIFT") # Muestra el título en la aplicación web.
                                               # Displays the title in the web app.
...
if uploaded_file1 and uploaded_file2:
    ...
    img1 = np.array(Image.open(uploaded_file1))
    ...
    # Llama a find_overlap() para calcular la superposición.
    # Muestra la imagen con las coincidencias resaltadas.
    # Presenta el porcentaje de coincidencia.